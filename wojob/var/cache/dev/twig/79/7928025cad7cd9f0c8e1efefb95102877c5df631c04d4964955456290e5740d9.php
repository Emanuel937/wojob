...
class __TwigTemplate_09711a113f5646034f1042da3736e858809ea4d3f59d0bfd9adfa27551bb82e1 extends Template
{
    private $source;
    private $macros = [];
...
<html>
  ...
  \t<main>
      ...
      <div class=\"text-center\" id=\"seconddiv\">
        ...
        echo "\">  publier video cv</a> 
          <a  id=\"studioAnnonceButton\" style=\"cursor: pointer;\"> je faire un annonce </a>
        </p>
  ...
  \t</main>  \t
   ";
        // line 163
        $this->loadTemplate("App/component/footer.html.twig", "App/page/home.html.twig", 163)->display($context);
        // line 164
...
<html>";
    ...
    {
        return array (  244 => 166,  238 => 164,  236 => 163,  138 => 68,  93 => 26,  89 => 25,  76 => 14,  74 => 13,  67 => 9,  63 => 8,  59 => 7,  55 => 6,  50 => 5,  48 => 4,  43 => 1,);
    }
...
<html>
  ...
  \t<main>
      ...
      <div class=\"text-center\" id=\"seconddiv\">
        ...
        <p class=\"text-center m-5 text-white \" >
          <a href=\"{{path('video')}}\" style=\"background-color:#007bff\">see all video </a>
          <a style=\"cursor: pointer;\" href=\"{{path('m_v_s')}}\">  publier video cv</a> 
          <a  id=\"studioAnnonceButton\" style=\"cursor: pointer;\"> je faire un annonce </a>
        </p>
